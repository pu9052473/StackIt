...
export const handleImageUpload = async (
  ...
  // Upload to UploadThing (actual upload after progress is complete)
  const response = await uploadFiles("editorImage", {
    files: [file],
  });
...
console.log("response: ", response)
  return response[0].url; // return uploaded image URL
};
